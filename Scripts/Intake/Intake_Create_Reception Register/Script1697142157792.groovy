...
WebUI.setText(findTestObject('Object Repository/Page_Create Person - SDICMS/input__ReceptionRegister.Reason_For_Visit'), 
    'abuse')

WebUI.click(findTestObject('Object Repository/Page_Create Person - SDICMS/input__ReceptionRegister.Visit_Date'))

WebUI.click(findTestObject('Object Repository/Page_Create Person - SDICMS/a_4'))
